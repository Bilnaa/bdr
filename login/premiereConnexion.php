...
<head>
    ...
    <link rel="shortcut icon" href="img/logo_bois_du_roy.png" type="image/x-icon">
    <link rel="apple-touch-icon" sizes="180x180" href="img/logo_bois_du_roy.png">
    <link rel="icon" type="image/png" sizes="32x32" href="img/logo_bois_du_roy.png">
    ...
    <body>
        <div class="w-screen h-screen flex justify-center items-center">
          <div class="w-full max-w-md">
            ...
            <h2 class="text-center text-3xl font-bold tracking-tight text-gray-900">Première connexion</h2> 
            <form class="mt-8 space-y-6" action="/bdr/libs/firstConnexion.php" method="POST">
